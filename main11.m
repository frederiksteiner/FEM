...
%%
figure
mesh_function_plot3d(uh,m);
figure
mesh_function_plot3d(vh,m);
v = [-2 -2 5];
[caz,cel] = view(v)


%% Situation 2
p1 = 1; p2 = 0; p3 = 0.5; a = 0.2; b = 0.1; c = 1000; d = 1000; e = 28; f = 55; T = 4; dt = 10^(-4)/4;
u0f = @(x,y,z) L(x,y,z,p1,p2,p3)*0.5 + (1-L(x,y,z,p1,p2,p3))*1;
v0f = @(x,y,z) L(x,y,z,p1,p2,p3)*0.25;
[uh, vh, ts, gs] = gray_scott(a, b, c, d, e, f, m, u0f, v0f, dt, T);
